...
Remove-Module AzureRM.Extensions -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\AzureRM.Extensions.psd1"
Import-Module "$PSScriptRoot\..\AzureRM.Extensions.psm1" -Force
