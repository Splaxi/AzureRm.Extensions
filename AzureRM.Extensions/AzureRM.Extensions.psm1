...
if ($AzureRM.Extensions_dotsourcemodule) { $script:doDotSource = $true }
...
$importIndividualFiles = Get-PSFConfigValue -FullName AzureRM.Extensions.Import.IndividualFiles -Fallback $false
if ($AzureRM.Extensions_importIndividualFiles) { $importIndividualFiles = $true }
