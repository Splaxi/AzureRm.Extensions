<#
	.SYNOPSIS
		Installs the AzureRM.Extensions Module from github
		
	.DESCRIPTION
		This script installs the AzureRM.Extensions Module from github.
